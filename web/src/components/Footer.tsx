export function Footer() {
  return (
    <footer className="bg-base border-t border-white/5">
      <div className="max-w-[1200px] mx-auto px-6 md:px-8 py-10">
        <div className="flex flex-col sm:flex-row items-center justify-between gap-4">
          <div className="flex items-center gap-2.5">
            <img src="/icon-ready.png" alt="TensorChat" className="w-5 h-5 rounded-md opacity-60" />
            <span className="text-xs text-text-tertiary">
              &copy; {new Date().getFullYear()} TensorChat By General Intelligence
            </span>
          </div>
          ...
          <div className="flex items-center gap-6 text-xs text-text-tertiary">
            <a
              ...
              className="hover:text-text-secondary transition-colors inline-flex items-center gap-1.5"
            >
